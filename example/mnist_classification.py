...
'''
[Tensorflow2 강의] 16강 MNIST Classification 강의 예제샘플
https://www.youtube.com/watch?v=x5LhoSZ7_AI&list=PLtm_YtKTtDkQJtgGSQnZzMJBRHyqANnQi&index=17
'''
...
def validation():
    ...
    for images, labels in validation_ds:
        ...
        validation_acc(labels, predications)
